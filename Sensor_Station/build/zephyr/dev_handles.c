 ...
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_50000000_S_gpio_842500[] = { DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, 8, 11, 10, 9, DEVICE_HANDLE_ENDS };
 ...
 *    - /soc/peripheral@50000000/i2c@9000/bme688@76
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_50000000_S_i2c_9000[] = { DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, 13, 12, DEVICE_HANDLE_ENDS };
 ...
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_50000000_S_spi_c000[] = { 3, 2, DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, 11, DEVICE_HANDLE_ENDS };
...
/* 11 : /soc/peripheral@50000000/spi@c000/spi-dev-adxl362@0:
 * Direct Dependencies:
 *    - /soc/peripheral@50000000/spi@c000
 *    - /soc/peripheral@50000000/gpio@842500
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_50000000_S_spi_c000_S_spi_dev_adxl362_0[] = { 8, 3, DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, DEVICE_HANDLE_ENDS };

/* 12 : /soc/peripheral@50000000/i2c@9000/bme688@76:
 * Direct Dependencies:
 *    - /soc/peripheral@50000000/i2c@9000
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_50000000_S_i2c_9000_S_bme688_76[] = { 6, DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, DEVICE_HANDLE_ENDS };

/* 13 : /soc/peripheral@50000000/i2c@9000/bmm150@10:
 * Direct Dependencies:
 *    - /soc/peripheral@50000000/i2c@9000
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_50000000_S_i2c_9000_S_bmm150_10[] = { 6, DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, DEVICE_HANDLE_ENDS };
